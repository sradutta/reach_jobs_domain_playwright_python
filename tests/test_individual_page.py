'''
This test takes the url that is being passed through pytest parametrization;
it navigates to the URL, and takes the first job that it is listed.
It then searches by that job, and return how many such jobs were found.
Through this proces, it is testing the page and also the search function.
'''
