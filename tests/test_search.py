'''
This test takes each url from the reach_jobs_domain.txt file.
...
Through this process, it is testing each of the pages and the search function
present in each of the pages.
'''
